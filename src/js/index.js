var app = angular.module('f1CdtAdpq', ['ngRoute', 'ui.router', 'config', 'ngMessages']);
app.config(function($locationProvider, $mdThemingProvider, $qProvider) {
  $locationProvider.html5Mode(true).hashPrefix('!');
})
.run(function(parseApplicationId, parseJavascriptKey, serverUrl, $state, $location) {
