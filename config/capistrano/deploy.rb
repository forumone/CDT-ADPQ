...
set :application, 'cdt_adpq'

# The repo URL
set :repo_url, 'git@github.com:forumone/CDT-ADPQ.git'
...
# rsync settings
set :rsync_options, %w[--recursive --chmod=Dug=rwx,Do=rx --perms --delete --delete-excluded --exclude=.git* --exclude=node_modules --exclude=build]
